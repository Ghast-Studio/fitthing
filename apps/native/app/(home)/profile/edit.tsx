      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <Card>
          <Card.Body>
            ...
            {/* Level Selection */}
            <View style={styles.section}>
              <Text style={[styles.label, { color: mutedColor }]}>Experience Level</Text>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.buttonRow}>
                ...
                <Button
                  variant={formData.units === "imperial" ? "primary" : "secondary"}
            ...
            <View style={styles.section}>
              ...
              <View style={styles.chipContainer}>
                {(["morning", "afternoon", "evening", "anytime"] as const).map((time) => (
                  <Chip
                    key={time}
                    variant={formData.preferredWorkoutTime === time ? "primary" : "secondary"}
                    color={formData.preferredWorkoutTime === time ? "accent" : "default"}
                    onPress={() =>
                      setFormData({
                        ...formData,
