...
export default function ActiveWorkoutPage() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor }]} edges={["bottom"]}>
      ...
      {/* Stats Bar */}
      <View style={[styles.statsBar, { backgroundColor: surfaceColor, borderBottomColor: borderColor }]}>
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => {
          const exercise = allExercises.find((ex: any) => ex.externalId === item.exerciseId);
                  ...
                  <View style={styles.setRow}>
                    ...
                    <Pressable
                      style={[
                        styles.checkButton,
                        {
                          borderColor: item.completed ? successColor : accentColor,
                          backgroundColor: item.completed ? successColor : "transparent",
                        },
                      ]}
                      onPress={() => handleUpdateSet(index, "completed", !item.completed)}
                    >
                      <Ionicons
