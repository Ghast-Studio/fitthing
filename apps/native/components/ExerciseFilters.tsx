    ...
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet">
      <View style={[styles.container, { backgroundColor }]}>
        ...
        >
          ...
          <Text style={[styles.headerTitle, { color: foregroundColor }]}>
            Filters
          </Text>
        ...
        <ScrollView style={styles.content}>
          {/* Level */}
          <FilterSection title="Level" borderColor={borderColor} foregroundColor={foregroundColor}>
            {LEVELS.map((level) => (
              <Pressable
                key={level}
                onPress={() =>
                  setLocalFilters({
                    ...localFilters,
                    level: localFilters.level === level ? undefined : (level as any),
                  })
                }
              >
                <Chip
          ...
          {/* Category */}
          <FilterSection title="Category" borderColor={borderColor} foregroundColor={foregroundColor}>
            {CATEGORIES.map((category) => (
              <Pressable
                ...
                onPress={() =>
                  setLocalFilters({
                    ...localFilters,
                    category: localFilters.category === category ? undefined : (category as any),
                  })
                }
              >
                <Chip
                  size="md"
                  variant={localFilters.category === category ? "primary" : "secondary"}
                  color={localFilters.category === category ? "accent" : "default"}
                >
          ...
          {/* Primary Muscles */}
          <FilterSection title="Primary Muscles" borderColor={borderColor} foregroundColor={foregroundColor}>
            {MUSCLES.map((muscle) => (
          ...
          {/* Secondary Muscles */}
          <FilterSection title="Secondary Muscles" borderColor={borderColor} foregroundColor={foregroundColor}>
            {MUSCLES.map((muscle) => (
              <Pressable key={muscle} onPress={() => toggleMuscle(muscle, "secondary")}>
                <Chip
                  size="md"
                  variant={
          ...
          {/* Equipment */}
          <FilterSection title="Equipment" borderColor={borderColor} foregroundColor={foregroundColor}>
            {EQUIPMENT.map((equipment) => (
              ...
              >
                <Chip
                  size="md"
                  variant={localFilters.equipment === equipment ? "primary" : "secondary"}
                  color={localFilters.equipment === equipment ? "accent" : "default"}
                >
          ...
          {/* Mechanic */}
          <FilterSection title="Mechanic" borderColor={borderColor} foregroundColor={foregroundColor}>
              ...
              <Pressable
                ...
                onPress={() =>
                  setLocalFilters({
                    ...localFilters,
                    mechanic:
                      localFilters.mechanic === mechanic ? undefined : (mechanic as any),
                  })
                }
              >
                <Chip
                  size="md"
                  variant={localFilters.mechanic === mechanic ? "primary" : "secondary"}
                  color={localFilters.mechanic === mechanic ? "accent" : "default"}
                >
